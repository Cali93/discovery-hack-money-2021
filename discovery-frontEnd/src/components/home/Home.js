  ...
  render() {
    ...
    return (
      <Container maxWidth="lg">
        <header className="">
          <div className="">
            <img src="https://images.unsplash.com/photo-1614732484003-ef9881555dc3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80" alt="dg" />
          </div>
        </header>
